    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl leading-relaxed text-foreground/75">
          ...
          vous-même en quelques minutes, chez vous, et vous les gardez pour une prochaine fois.
          Choisissez un set d&rsquo;une collection ou faites-en dessiner un rien que pour vous.
        </p>
      </div>
