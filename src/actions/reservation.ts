  ...
  try {
    rendezVousId = await prisma.$transaction(
      async (tx) => {
        ...
        // Le même filtre que les créneaux proposés — tout rendez-vous non annulé
        // retient sa fenêtre. Un créneau montré libre puis refusé à la
        // validation serait pire que ne pas l'avoir montré.
